...
Before we begin learning about R Objects, it is important to learn about different data types. For this class, there are three types of data: numeric, character, and logical. There are other types of data; however, we will most likely not use them.
